...
class AgentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('agent.index', compact('rows', 'settings','request','type'));
    }
    ...
    public function create()
    {
        ...
        $settings = Employee::settings(1,3);
        return view('agent.create', compact('settings'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agent.index')->with('success',__('agent.delr'));
    }
    ...
    public function show($id)
    {
        ...
        return view('agent.edit',compact('model','settings'));
    }
    ...
    public function update($id,Request $request)
    {
      ...
      //  print_r($request); exit;
       $model->update($data);
        ...
        return redirect()->route('agent.index')->with('success',__('agent.upr'));
    }
